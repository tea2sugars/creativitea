					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 m-b-30">
								...
								<p>Being a start-up FiveThree approached us to develop them a brand identity, and then to implement this across various company outputs including a website, stationery and client facing presentations.</p>
							</div>
