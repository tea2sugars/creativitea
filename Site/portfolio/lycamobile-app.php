					...
					<div class="col-md-8 col-sm-offset-4" >
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 m-b-30">
								...
								<p>The app is to give customers access to their mobile accounts quickly and easily, giving them everything they need to know; from how much their spending, to helpful tips to get the most out of their account and phone.</p>
							</div>
...
<p>The user interface design features a flat User Interface (UI) design using the brands existing identity system based around the use of colour and typeface, with a bespoke icon set.</p>

<p>The App design was for the Android operating system, with other operating systems to be considered in the future. The new design now is being used as a ‘best practice’ guide to other app designs within the service and product portfolio of Lycamobile.
</p>
