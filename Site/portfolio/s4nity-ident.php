					...
					<div class="col-md-8">
						...
						<div class="row multi-columns-row">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 m-b-30">
								...
								<p>After the successful launch of S4NITY's new brand we decided to take the mascot - S4, to new heights, transforming the flat 2d visuals into moving images. The task was to create a short ident that would take a subject matter that can often be regarded as confusing, and make it appeal to a broad audience - whilst retaining the essence of S4NITY's values and new identity.</p>
							</div>
							...
							<div class="col-sm-12 col-md-12 col-lg-12 m-b-30">
								...
								<p>The project won Platinum Award in the Movie and Animation Design category at the A’Design Awards and also featured in International Brand Design Magazine.</p>
